function [stazioneLat, stazioneLon] = generaStazione(centroLat, centroLon, superficie)
    ...
    % deltaLat = (distanza / raggioTerra) * (180 / pi);
    % deltaLon = (distanza / raggioTerra) * (180 / pi) / cosd(centroLat);
    % 
